...
#dbpf(SIM_IOC:m1.FOFF, "1") # the unit offset is Frozen
#dbpf(SIM_IOC:m2.FOFF, "1") # the unit offset is Frozen
#dbpf(SIM_IOC:m3.FOFF, "1") # the unit offset is Frozen
#dbpf(SIM_IOC:m4.FOFF, "1") # the unit offset is Frozen
