...
/* Generated from ../O.Common/pi_e712WithAsyn.dbd */
...
static const char * const recordTypeNames[] = {
    ...
    "mbbi", "mbbiDirect", "mbbo", "mbboDirect", "motor", "permissive",
    "printf", "scalcout", "sel", "seq", "sseq", "state", "stringin",
...
epicsShareExtern reg_func pvar_func_PIE712DriverRegister,
    ...
    pvar_func_interpRegister, pvar_func_motorRegister,
...
int pi_e712WithAsyn_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/bergr/git_sandbox/cs_apps/Beamlines/SM_Beamline/STXM/ASTXM/AStxm_PIE712App";
    ...
    pvar_func_PIE712DriverRegister();
    pvar_func_aCalcMonitorMemRegister();
...
/* pi_e712WithAsyn_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"pi_e712WithAsyn_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(pi_e712WithAsyn_registerRecordDeviceDriver(*iocshPpdbbase));
}
